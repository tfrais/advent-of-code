...
object ConsoleApp {
    ...
    private val solution: AdventOfCodeDaySolution = cz.frais.aoc.year2015.day13.Year2015Day13
    private val input: String = object {}.javaClass.getResource("/2015/day13_input.txt")!!.readText()
