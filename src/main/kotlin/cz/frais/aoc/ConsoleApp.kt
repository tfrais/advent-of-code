...
object ConsoleApp {
    ...
    private val solution: AdventOfCodeDaySolution = cz.frais.aoc.year2015.day12.Year2015Day12
    private val input: String = object {}.javaClass.getResource("/2015/day12_input.txt")!!.readText()
