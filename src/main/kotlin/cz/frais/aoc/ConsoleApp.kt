...
object ConsoleApp {
    ...
    private val solution: AdventOfCodeDaySolution = cz.frais.aoc.year2015.day18.Year2015Day18
    private val input: String = object {}.javaClass.getResource("/2015/day18_input.txt")!!.readText()
