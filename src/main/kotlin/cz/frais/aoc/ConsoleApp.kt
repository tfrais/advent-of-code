...
object ConsoleApp {
    ...
    private val solution: AdventOfCodeDaySolution = cz.frais.aoc.year2015.day22.Year2015Day22
    private val input: String = object {}.javaClass.getResource("/2015/day22_input.txt")!!.readText()
