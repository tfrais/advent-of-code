...
object ConsoleApp {
    ...
    private val solution: AdventOfCodeDaySolution = cz.frais.aoc.year2015.day19.Year2015Day19
    private val input: String = object {}.javaClass.getResource("/2015/day19_input.txt")!!.readText()
