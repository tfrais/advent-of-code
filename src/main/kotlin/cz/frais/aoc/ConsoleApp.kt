...
object ConsoleApp {
    ...
    private val solution: AdventOfCodeDaySolution = cz.frais.aoc.year2015.day24.Year2015Day24
    private val input: String = object {}.javaClass.getResource("/2015/day24_input.txt")!!.readText()
