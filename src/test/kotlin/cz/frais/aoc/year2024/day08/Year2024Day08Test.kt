...
import cz.frais.aoc.year2024.day08.Year2024Day08.antinodePositions
...
class Year2024Day08Test {
    ...
    @Test
    fun testAntinodePositions() {
        assertThat(antinodePositions(Position(4, 3), Position(5, 5)))
            .containsExactlyInAnyOrder(Position(3, 1), Position(6, 7))

        assertThat(antinodePositions(Position(5, 5), Position(4, 3)))
            .containsExactlyInAnyOrder(Position(3, 1), Position(6, 7))

        assertThat(antinodePositions(Position(1, 0), Position(2, 0)))
            .containsExactlyInAnyOrder(Position(0, 0), Position(3, 0))

        assertThat(antinodePositions(Position(0, 1), Position(0, 2)))
